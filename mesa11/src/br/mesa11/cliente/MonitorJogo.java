...
public class MonitorJogo extends Thread {
	...
	private void atualizaDadosJogoSrvMesa11() {
		...
		if (dadosJogoSrvMesa11 == null) {
			System.out
					.println("atualizaDadosJogoSrvMesa11() dadosJogoSrvMesa11==null");
			return;
		}
		dormir(tempoDormir);
		...
		if (ret != null && ret instanceof Mesa11TO) {
			...
			if (animacao != null && animacao.getIndex() > indexAnimacaoAtual) {
				indexAnimacaoAtual = animacao.getIndex();
				controleJogo.executaAnimacao(animacao);
				System.out
						.println("Excuta Animacao");
			}
		...
		if (ret != null && ret instanceof Mesa11TO) {
			...
			PosicaoBtnsSrvMesa11 posicaoBtnsSrvMesa11 = (PosicaoBtnsSrvMesa11) mesa11to
					.getData();
			if (!controleJogo.isAnimando() && posicaoBtnsSrvMesa11 != null
